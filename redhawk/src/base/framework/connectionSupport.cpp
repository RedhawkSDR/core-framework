...
#include "ossie/PersistanceStore.h"
#endif
...
namespace ossie {
    ...
    public:
        ...
        virtual bool checkDependency(DependencyType type, const std::string& identifier) const
        {
            return true;    // in the case of a service, always try to make a new one, so return true for the dependency check
        }
...
bool ConnectionNode::checkDependency(Endpoint::DependencyType type, const std::string& identifier)
{
