...
IDM_Channel_Consumer_i::IDM_Channel_Consumer_i (DomainManager_impl *_dmn)
{
    TRACE_ENTER(DomainManager_impl)
...
void IDM_Channel_Consumer_i::push (const CORBA::Any& _any) throw (CORBA::SystemException, CosEventComm::Disconnected)
{
    TRACE_ENTER(DomainManager_impl)
    CORBA::ULong tmp = 0;
    float tmp2 = 0.0;
...
void IDM_Channel_Consumer_i::disconnect_push_consumer () throw (CORBA::SystemException)
{
    TRACE_ENTER(DomainManager_impl)
    TRACE_EXIT(DomainManager_impl)
}
...
ODM_Channel_Supplier_i::ODM_Channel_Supplier_i (DomainManager_impl *_dmn)
{
    TRACE_ENTER(DomainManager_impl)
...
void ODM_Channel_Supplier_i::disconnect_push_supplier ()
{
    TRACE_ENTER(DomainManager_impl)
    TRACE_EXIT(DomainManager_impl)
}
