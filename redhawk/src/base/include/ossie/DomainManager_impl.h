...
#include "DomainManagerConfiguration.h"
#include "CF/StandardEvent.h"
...
#if ENABLE_EVENTS
class OSSIECF_API IDM_Channel_Consumer_i: public virtual POA_CosEventComm::PushConsumer
{
...
class OSSIECF_API ODM_Channel_Supplier_i : virtual public POA_CosEventComm::PushSupplier
{
...
class OSSIECF_API
DomainManager_impl: public virtual POA_CF::DomainManager, public PropertySet_impl, public ossie::ComponentLookup, public ossie::DomainLookup, public ossie::Runnable
{
    ENABLE_LOGGING
...
protected:
    ...
    vector < ossie::ApplicationFactoryNode > _installedApplications;
    vector < ossie::ApplicationNode > _runningApplications;
    ossie::ServiceList _registeredServices;
#if ENABLE_EVENTS
    vector < ossie::EventChannelNode > _eventChannels;
#endif
