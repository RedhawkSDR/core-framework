...
ln -sf %{_prefix}/lib/slf4j-api-1.7.36.jar    %{buildroot}/usr/local/redhawk/core/lib/slf4j-api.jar
ln -sf %{_prefix}/lib/slf4j-reload4j-1.7.36.jar    %{buildroot}/usr/local/redhawk/core/lib/slf4j-reload4j.jar
...
%{_prefix}/lib/slf4j-api-1.7.36.jar
%{_prefix}/lib/slf4j-reload4j.jar
%{_prefix}/lib/slf4j-reload4j-1.7.36.jar
