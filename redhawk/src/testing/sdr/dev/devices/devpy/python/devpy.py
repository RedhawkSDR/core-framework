...
# AUTO-GENERATED
#
# Source: devpy.spd.xml
from ossie.device import start_device
import logging
import helloworld
from devpy_base import *

class devpy_i(devpy_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", devpy_i.MyMsg, self.msg_callback)
