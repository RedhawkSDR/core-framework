...
# AUTO-GENERATED
#
# Source: bad_init_device.spd.xml
from ossie.device import start_device
import logging

from bad_init_device_base import *

class bad_init_device_i(bad_init_device_base):
    ...
    def initialize(self):
        ...
        """
        bad_init_device_base.initialize(self)
        raise CF.LifeCycle.InitializeError(["Initialize error"])
