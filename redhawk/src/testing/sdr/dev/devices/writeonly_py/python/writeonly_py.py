...
from writeonly_py_base import *

class writeonly_py_i(writeonly_py_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", writeonly_py_i.MyMsg, self.msg_callback)
