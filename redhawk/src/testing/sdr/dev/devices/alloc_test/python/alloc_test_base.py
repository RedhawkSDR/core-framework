...
class alloc_test_base(CF__POA.Device, Device, ThreadedComponent):
        ...
        callback_test = simple_property(id_="callback_test",
                                        type_="short",
                                        mode="readwrite",
                                        action="external",
                                        kinds=("allocation",))
        
        callback_value = simple_property(id_="callback_value",
                                         type_="short",
                                         mode="readonly",
                                         action="external",
                                         kinds=("configure",))
