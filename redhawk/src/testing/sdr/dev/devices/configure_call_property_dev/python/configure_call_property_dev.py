...
# AUTO-GENERATED
#
# Source: configure_call_property_dev.spd.xml
from ossie.device import start_device
import logging

from configure_call_property_dev_base import *

class configure_call_property_dev_i(configure_call_property_dev_base):
    ...
    def configure(self, props):
        configure_call_property_dev_base.configure(self, props)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", configure_call_property_dev_i.MyMsg, self.msg_callback)
            ...
            msg_out = configure_call_property_dev_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_device(configure_call_property_dev_i)
