...
class configure_call_property_dev_base(CF__POA.Device, Device, ThreadedComponent):
        ...
        configure_called = simple_property(id_="configure_called",
                                           type_="boolean",
                                           defvalue=False,
                                           mode="readwrite",
                                           action="external",
        ...
        some_prop = simple_property(id_="some_prop",
                                    type_="string",
                                    defvalue="abc",
                                    mode="readwrite",
                                    action="external",
