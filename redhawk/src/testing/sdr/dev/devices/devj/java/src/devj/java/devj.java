 ...
 * Source: devj.spd.xml
 */
public class devj extends devj_base {
    /**
    ...
    protected int serviceFunction() {
        logger.debug("serviceFunction() example debug message");
        logger.info("serviceFunction() example info message");
        logger.warn("serviceFunction() example warn message");
        logger.error("serviceFunction() example error message");
        logger.fatal("serviceFunction() example fatal message");
