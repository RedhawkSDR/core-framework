...
#include "dev_kill_devmgr.h"

PREPARE_LOGGING(dev_kill_devmgr_i)

dev_kill_devmgr_i::dev_kill_devmgr_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl) :
    dev_kill_devmgr_base(devMgr_ior, id, lbl, sftwrPrfl)
{
	kill(getppid(), 9);
}

dev_kill_devmgr_i::dev_kill_devmgr_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev) :
    dev_kill_devmgr_base(devMgr_ior, id, lbl, sftwrPrfl, compDev)
{
}

dev_kill_devmgr_i::dev_kill_devmgr_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities) :
    dev_kill_devmgr_base(devMgr_ior, id, lbl, sftwrPrfl, capacities)
{
}

dev_kill_devmgr_i::dev_kill_devmgr_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev) :
    dev_kill_devmgr_base(devMgr_ior, id, lbl, sftwrPrfl, capacities, compDev)
{
}

dev_kill_devmgr_i::~dev_kill_devmgr_i()
{
}

void dev_kill_devmgr_i::constructor()
{
    /***********************************************************************************
...
**************************************************************************/
void dev_kill_devmgr_i::updateUsageState()
{
}
...
/***********************************************************************************************
    ...
    Messages:
        ...
        void dev_kill_devmgr_i::my_message_callback(const std::string& id, const my_msg_struct &msg){
        }
        
        Register the message callback onto the input port with the following form:
        this->msg_input->registerMessage("my_msg", this, &dev_kill_devmgr_i::my_message_callback);
    ...
    Properties:
        ...
        addPropertyListener(<property>, this, &dev_kill_devmgr_i::<callback method>)
        in the constructor.
        ...
        //Add to dev_kill_devmgr.cpp
        dev_kill_devmgr_i::dev_kill_devmgr_i(const char *uuid, const char *label) :
            dev_kill_devmgr_base(uuid, label)
        {
            addPropertyListener(scaleValue, this, &dev_kill_devmgr_i::scaleChanged);
            addPropertyListener(status, this, &dev_kill_devmgr_i::statusChanged);
        }

        void dev_kill_devmgr_i::scaleChanged(float oldValue, float newValue)
        {
            LOG_DEBUG(dev_kill_devmgr_i, "scaleValue changed from" << oldValue << " to " << newValue);
        }
            
        void dev_kill_devmgr_i::statusChanged(const status_struct& oldValue, const status_struct& newValue)
        {
            LOG_DEBUG(dev_kill_devmgr_i, "status changed");
        }
            
        //Add to dev_kill_devmgr.h
    ...
    Allocation:
        ...
        bool dev_kill_devmgr_i::my_alloc_fn(const std::string &value)
        {
            // perform logic
            return true; // successful allocation
        }
        void dev_kill_devmgr_i::my_dealloc_fn(const std::string &value)
        {
            // perform logic
        }
        ...
        this->setAllocationImpl(my_alloc, this, &dev_kill_devmgr_i::my_alloc_fn, &dev_kill_devmgr_i::my_dealloc_fn);
        
        

************************************************************************************************/
int dev_kill_devmgr_i::serviceFunction()
{
    LOG_DEBUG(dev_kill_devmgr_i, "serviceFunction() example log message");
