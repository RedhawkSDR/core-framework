...
#ifndef ISSUE_111_CPP_IMPL_BASE_H
#define ISSUE_111_CPP_IMPL_BASE_H
...
class issue_111_cpp_base : public Device_impl
{

    public:
        issue_111_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl);
        issue_111_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev);
        issue_111_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities);
        issue_111_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev);
    ...
    protected:
        ProcessThread<issue_111_cpp_base> *serviceThread; 
