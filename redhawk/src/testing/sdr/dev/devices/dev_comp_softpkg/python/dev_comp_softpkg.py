...
# AUTO-GENERATED
#
# Source: dev_comp_softpkg.spd.xml
from ossie.device import start_device
import logging

from dev_comp_softpkg_base import *

class dev_comp_softpkg_i(dev_comp_softpkg_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", dev_comp_softpkg_i.MyMsg, self.msg_callback)
            ...
            msg_out = dev_comp_softpkg_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_device(dev_comp_softpkg_i)
