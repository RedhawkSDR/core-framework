...
from py_dev_exec_params_base import *

class py_dev_exec_params_i(py_dev_exec_params_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", py_dev_exec_params_i.MyMsg, self.msg_callback)
            ...
            msg_out = py_dev_exec_params_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_device(py_dev_exec_params_i)
