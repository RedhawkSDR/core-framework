...
from PythonExecDev_python_impl1_base import * 

class PythonExecDev_python_impl1_i(PythonExecDev_python_impl1_base):
    """<DESCRIPTION GOES HERE>"""
    def initialize(self):
        PythonExecDev_python_impl1_base.initialize(self)
        self.updateUsageState()
    
    def updateUsageStateThatWillNeverGetCallled(self):
        """
