...
# AUTO-GENERATED
#
# Source: device_fork.spd.xml
from ossie.device import start_device
import logging

from device_fork_base import *
import os
import ossie.utils as _utils
from omniORB import any as _any

class device_fork_i(device_fork_base):
    ...
    def constructor(self):
        ...
        sp = _utils.Popen(['python', '../../../dev/devices/device_fork/python/loop.py'])
        self._pid = sp.pid
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", device_fork_i.MyMsg, self.msg_callback)
