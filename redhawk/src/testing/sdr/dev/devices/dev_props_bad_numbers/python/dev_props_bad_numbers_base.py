...
class dev_props_bad_numbers_base(CF__POA.Device, Device, ThreadedComponent):
        ...
        some_float = simple_property(id_="some_float",
                                     type_="float",
                                     defvalue=5.0,
                                     mode="readwrite",
                                     action="external",
        ...
        some_short = simple_property(id_="some_short",
                                     type_="short",
                                     defvalue=4,
                                     mode="readwrite",
                                     action="external",
