...
# AUTO-GENERATED
#
# Source: dev_props_bad_numbers.spd.xml
from ossie.device import start_device
import logging

from dev_props_bad_numbers_base import *

class dev_props_bad_numbers_i(dev_props_bad_numbers_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", dev_props_bad_numbers_i.MyMsg, self.msg_callback)
            ...
            msg_out = dev_props_bad_numbers_i.MyMsg()
