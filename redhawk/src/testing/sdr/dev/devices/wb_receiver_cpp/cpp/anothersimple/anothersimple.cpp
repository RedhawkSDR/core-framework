...
anothersimple_i::anothersimple_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl) :
    anothersimple_base(devMgr_ior, id, lbl, sftwrPrfl)
{
}

anothersimple_i::anothersimple_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev) :
    anothersimple_base(devMgr_ior, id, lbl, sftwrPrfl, compDev)
{
}

anothersimple_i::anothersimple_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities) :
    anothersimple_base(devMgr_ior, id, lbl, sftwrPrfl, capacities)
{
}

anothersimple_i::anothersimple_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev) :
    anothersimple_base(devMgr_ior, id, lbl, sftwrPrfl, capacities, compDev)
{
}

anothersimple_i::~anothersimple_i()
{
}

void anothersimple_i::constructor()
{
    /***********************************************************************************
...
**************************************************************************/
void anothersimple_i::updateUsageState()
{
}
...
/***********************************************************************************************
    ...
    Messages:
        ...
        void anothersimple_i::my_message_callback(const std::string& id, const my_msg_struct &msg){
        }
        
        Register the message callback onto the input port with the following form:
        this->msg_input->registerMessage("my_msg", this, &anothersimple_i::my_message_callback);
    ...
    Properties:
        ...
        addPropertyListener(<property>, this, &anothersimple_i::<callback method>)
        in the constructor.
        ...
        //Add to anothersimple.cpp
        anothersimple_i::anothersimple_i(const char *uuid, const char *label) :
            anothersimple_base(uuid, label)
        {
            addPropertyListener(scaleValue, this, &anothersimple_i::scaleChanged);
            addPropertyListener(status, this, &anothersimple_i::statusChanged);
        }

        void anothersimple_i::scaleChanged(float oldValue, float newValue)
        {
            RH_DEBUG(this->_baseLog, "scaleValue changed from" << oldValue << " to " << newValue);
        }
            
        void anothersimple_i::statusChanged(const status_struct& oldValue, const status_struct& newValue)
        {
            RH_DEBUG(this->_baseLog, "status changed");
        }
            
        //Add to anothersimple.h
    ...
    Allocation:
        ...
        bool anothersimple_i::my_alloc_fn(const std::string &value)
        {
            // perform logic
            return true; // successful allocation
        }
        void anothersimple_i::my_dealloc_fn(const std::string &value)
        {
            // perform logic
        }
        ...
        this->setAllocationImpl(my_alloc, this, &anothersimple_i::my_alloc_fn, &anothersimple_i::my_dealloc_fn);
        
        

************************************************************************************************/
int anothersimple_i::serviceFunction()
{
