...
# AUTO-GENERATED
#
# Source: log_test_py.spd.xml
from ossie.device import start_device
import logging

from log_test_py_base import *

class log_test_py_i(log_test_py_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", log_test_py_i.MyMsg, self.msg_callback)
