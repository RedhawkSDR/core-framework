...
# AUTO-GENERATED
#
# Source: python_dev.spd.xml
from ossie.device import start_device
import logging

from python_dev_base import *



class python_dev_i(python_dev_base):
    ...
    #python_dev_base.__init__(self, devmgr, uuid, label, softwareProfile, compositeDevice, execparams)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", python_dev_i.MyMsg, self.msg_callback)
