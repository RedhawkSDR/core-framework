...
# AUTO-GENERATED
#
# Source: cmdline_dev.spd.xml
from ossie.device import start_device
import logging

from cmdline_dev_base import *

class cmdline_dev_i(cmdline_dev_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", cmdline_dev_i.MyMsg, self.msg_callback)
