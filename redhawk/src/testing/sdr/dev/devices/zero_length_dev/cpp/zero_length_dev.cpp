...
#include "zero_length_dev.h"

PREPARE_LOGGING(zero_length_dev_i)

zero_length_dev_i::zero_length_dev_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl) :
    zero_length_dev_base(devMgr_ior, id, lbl, sftwrPrfl)
{
}

zero_length_dev_i::zero_length_dev_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev) :
    zero_length_dev_base(devMgr_ior, id, lbl, sftwrPrfl, compDev)
{
}

zero_length_dev_i::zero_length_dev_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities) :
    zero_length_dev_base(devMgr_ior, id, lbl, sftwrPrfl, capacities)
{
}

zero_length_dev_i::zero_length_dev_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev) :
    zero_length_dev_base(devMgr_ior, id, lbl, sftwrPrfl, capacities, compDev)
{
}

zero_length_dev_i::~zero_length_dev_i()
{
}

void zero_length_dev_i::constructor()
{
    /***********************************************************************************
...
**************************************************************************/
void zero_length_dev_i::updateUsageState()
{
}
...
/***********************************************************************************************
    ...
    Messages:
        ...
        void zero_length_dev_i::my_message_callback(const std::string& id, const my_msg_struct &msg){
        }
        
        Register the message callback onto the input port with the following form:
        this->msg_input->registerMessage("my_msg", this, &zero_length_dev_i::my_message_callback);
    ...
    Properties:
        ...
        addPropertyListener(<property>, this, &zero_length_dev_i::<callback method>)
        in the constructor.
        ...
        //Add to zero_length_dev.cpp
        zero_length_dev_i::zero_length_dev_i(const char *uuid, const char *label) :
            zero_length_dev_base(uuid, label)
        {
            addPropertyListener(scaleValue, this, &zero_length_dev_i::scaleChanged);
            addPropertyListener(status, this, &zero_length_dev_i::statusChanged);
        }

        void zero_length_dev_i::scaleChanged(float oldValue, float newValue)
        {
            LOG_DEBUG(zero_length_dev_i, "scaleValue changed from" << oldValue << " to " << newValue);
        }
            
        void zero_length_dev_i::statusChanged(const status_struct& oldValue, const status_struct& newValue)
        {
            LOG_DEBUG(zero_length_dev_i, "status changed");
        }
            
        //Add to zero_length_dev.h
    ...
    Allocation:
        ...
        bool zero_length_dev_i::my_alloc_fn(const std::string &value)
        {
            // perform logic
            return true; // successful allocation
        }
        void zero_length_dev_i::my_dealloc_fn(const std::string &value)
        {
            // perform logic
        }
        ...
        this->setAllocationImpl(my_alloc, this, &zero_length_dev_i::my_alloc_fn, &zero_length_dev_i::my_dealloc_fn);
        
        

************************************************************************************************/
int zero_length_dev_i::serviceFunction()
{
    LOG_DEBUG(zero_length_dev_i, "serviceFunction() example log message");
