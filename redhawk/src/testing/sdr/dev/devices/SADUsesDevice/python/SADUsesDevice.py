...
# AUTO-GENERATED
#
# Source: SADUsesDevice.spd.xml
# Generated on: Wed May 29 14:26:09 EDT 2013
# REDHAWK IDE
# Version: 1.8.4
...
from SADUsesDevice_base import * 

class SADUsesDevice_i(SADUsesDevice_base):
    ...
    def initialize(self):
        ...
        """
        SADUsesDevice_base.initialize(self)
        # TODO add customization here.
        
    def allocate_simple_alloc(self, value):
        if self.simple_alloc - value >= 0:
            self.simple_alloc -= value
            return True
        else:
            return False

    def deallocate_simple_alloc(self,value):
        if self.simple_alloc + value <= 10:
            self.simple_alloc += value
            return True
        else:
            return False
