...
# Generated on: Fri May 31 16:39:19 EDT 2013
# REDHAWK IDE
# Version: 1.8.4
...
class SADUsesDevice_base(CF__POA.ExecutableDevice, ExecutableDevice):
        ...
        port_dev_resource_in = providesport(name="dev_resource_in",
                                            repid="IDL:CF/Resource:1.0",
                                            type_="data",)

        port_dev_resource_out = usesport(name="dev_resource_out",
                                            repid="IDL:CF/Resource:1.0",
                                            type_="data",)        
...
class PortCFResourceIn_i(SADUsesDevice_base.PortCFResourceIn):
...
class PortCFResourceOut_i(SADUsesDevice_base.PortCFResourceOut):
    def __init__(self, parent, name):
        self.parent = parent
        self.name = name
        self.outConnections = {}
