...
PROPERTIES = (
              ...
              (
               u'modified_default', # ID
               u'modified_default', # NAME
               u'string', # TYPE
               u'readwrite', # MODE
               None, # DEFAULT
               None, # UNITS
              ...
              (
               u'writeonly_configure', # ID
               u'writeonly_configure', # NAME
               u'float', # TYPE
               u'writeonly', # MODE
               None, # DEFAULT
               None, # UNITS
              ...
              (
               u'writeonly_allocation', # ID
               u'writeonly_allocation', # NAME
               u'float', # TYPE
               u'writeonly', # MODE
               None, # DEFAULT
               None, # UNITS
              ...
              (
               u'check_STACK_SIZE', # ID
               u'check STACK SIZE', # NAME
               u'ulong', # TYPE
               u'readwrite', # MODE
               None, # DEFAULT
               None, # UNITS
