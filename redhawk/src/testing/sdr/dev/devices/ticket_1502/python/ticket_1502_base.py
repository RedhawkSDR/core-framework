...
class ticket_1502_base(CF__POA.Device, Device):
        ...
        simple_prop = simple_property(id_="simple_prop",
                                      ...
                                      action="external",
                                      kinds=("allocation","configure")                                 )
        prop_with_spaces = simple_property(id_="prop with spaces",
                                           type_="long",
                                           mode="readwrite",
                                           action="external",
                                           kinds=("allocation","configure")                                 )
        prop__with_colons = simple_property(id_="prop::with_colons",
                                            type_="short",
                                            mode="readwrite",
                                            action="external",
                                            kinds=("allocation","configure")                                 )
