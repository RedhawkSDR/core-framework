...
# AUTO-GENERATED
#
# Source: nocmdline_dev.spd.xml
from ossie.device import start_device
import logging

from nocmdline_dev_base import *

class nocmdline_dev_i(nocmdline_dev_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", nocmdline_dev_i.MyMsg, self.msg_callback)
