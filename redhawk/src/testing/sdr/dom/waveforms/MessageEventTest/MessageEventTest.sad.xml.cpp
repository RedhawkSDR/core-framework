...
<softwareassembly id="DCE:cbb6ec77-c38e-4cf8-8905-dbbb47503467" name="MessageEventTestCpp">
  <componentfiles>
    <componentfile id="MessageSenderCpp" type="SPD">
        <localfile name="/components/huge_msg_cpp/huge_msg_cpp.spd.xml"/>
    </componentfile>
  </componentfiles>
  <partitioning>
    <componentplacement>
        <componentfileref refid="MessageSenderCpp"/>
