...
# AUTO-GENERATED
#
# Source: test_componentinit.spd.xml
from ossie.resource import start_component
import logging

from test_componentinit_base import *

class test_componentinit_i(test_componentinit_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", test_componentinit_i.MyMsg, self.msg_callback)
            ...
            msg_out = test_componentinit_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(test_componentinit_i)
