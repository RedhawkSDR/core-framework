...
from MsgPort_P_base import *

class MsgPort_P_i(MsgPort_P_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", MsgPort_P_i.MyMsg, self.msg_callback)
