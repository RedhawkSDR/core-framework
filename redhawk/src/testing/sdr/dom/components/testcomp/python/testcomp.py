...
# AUTO-GENERATED
#
# Source: testcomp.spd.xml
from ossie.resource import start_component
import logging

from testcomp_base import *

class testcomp_i(testcomp_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", testcomp_i.MyMsg, self.msg_callback)
