...
# AUTO-GENERATED
#
# Source: start_timeout.spd.xml
from ossie.resource import start_component
import logging

from start_timeout_base import *

class start_timeout_i(start_timeout_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", start_timeout_i.MyMsg, self.msg_callback)
...
if __name__ == '__main__':
    ...
    start_component(start_timeout_i)
