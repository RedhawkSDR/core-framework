...
#
# Source: ticket_462_ac.spd.xml
# Generated on: Tue Apr 30 11:38:47 EDT 2013
# REDHAWK IDE
# Version: R.1.8.3
...
class ticket_462_ac_base(CF__POA.Resource, Resource):
        ...
        # or by using the IDE.       
        my_simple = simple_property(id_="my_simple",
                                          type_="string",
                                          mode="readwrite",
                                          action="external",
                                          kinds=("configure",)
                                          ) 
        my_seq = simpleseq_property(id_="my_seq",  
                                          type_="string",
                                          defvalue=None,
                                          mode="readwrite",
                                          action="external",
        ...
        class BasicStruct(object):
            ...
            def __str__(self):
                ...
                d = {}
                d["some_simple"] = self.some_simple
                return str(d)
            ...
            def getMembers(self):
                return [("some_simple",self.some_simple)]

        
        basic_struct = struct_property(id_="basic_struct",
                                          structdef=BasicStruct,
