...
from cmdline_def_py_base import *

class cmdline_def_py_i(cmdline_def_py_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", cmdline_def_py_i.MyMsg, self.msg_callback)
            ...
            msg_out = cmdline_def_py_i.MyMsg()
