...
# Generated on: Wed Apr 04 11:19:02 EDT 2012
# Redhawk IDE
# Version:T.1.X.X
...
from CommandWrapperStartCounter_base import * 

class CommandWrapperStartCounter_i(CommandWrapperStartCounter_base):
    ...
    def initialize(self):
        ...
        """
        CommandWrapperStartCounter_base.initialize(self)
    ...
    def start(self):
        self.startCounter = self.startCounter + 1    
        CommandWrapperStartCounter_base.start(self)
