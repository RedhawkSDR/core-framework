...
# Generated on: Mon Apr 15 15:45:34 EDT 2013
# REDHAWK IDE
# Version: R.1.8.3
...
from ac_with_properties_base import * 
from omniORB import any

class ac_with_properties_i(ac_with_properties_base):
    ...
    def initialize(self):
        ...
        """
        ac_with_properties_base.initialize(self)
        # TODO add customization here.
    
    def onconfigure_prop_trigger_property(self, oldval, newval):
        retprops = self.port_components.query([])
        myval = any.from_any(retprops[0].value)
        self.other_component = myval
        self.trigger_property = newval
...
if __name__ == '__main__':
    ...
    start_component(ac_with_properties_i)
