...
# AUTO-GENERATED
#
# Source: slow_stop.spd.xml
from ossie.resource import start_component
import logging

from slow_stop_base import *

class slow_stop_i(slow_stop_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", slow_stop_i.MyMsg, self.msg_callback)
