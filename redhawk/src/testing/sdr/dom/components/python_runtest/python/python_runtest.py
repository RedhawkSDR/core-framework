...
# AUTO-GENERATED
#
# Source: python_runtest.spd.xml
from ossie.resource import start_component
import logging

from python_runtest_base import *

class python_runtest_i(python_runtest_base):
    ...
    def runTest(self, testid, testValues):
        raise CF.UnknownProperties(testValues)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", python_runtest_i.MyMsg, self.msg_callback)
            ...
            msg_out = python_runtest_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(python_runtest_i)
