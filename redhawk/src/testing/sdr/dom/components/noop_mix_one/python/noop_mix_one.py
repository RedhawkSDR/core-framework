...
# AUTO-GENERATED
#
# Source: noop_mix_one.spd.xml
from ossie.resource import start_component
import logging

from noop_mix_one_base import *

class noop_mix_one_i(noop_mix_one_base):
    ...
    def initialize(self):
        ...
        """
        noop_mix_one_base.initialize(self)
...
if __name__ == '__main__':
    ...
    start_component(noop_mix_one_i)
