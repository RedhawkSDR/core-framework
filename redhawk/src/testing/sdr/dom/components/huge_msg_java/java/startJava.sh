...
JAVA_CLASSPATH=${JAVA_LIBDIR}/apache-commons-lang-2.4.jar:${JAVA_LIBDIR}/reload4j.jar:${JAVA_LIBDIR}/CFInterfaces.jar:${JAVA_LIBDIR}/ossie.jar:${myDir}/huge_msg_java.jar:${myDir}:${myDir}/bin:${CLASSPATH}
