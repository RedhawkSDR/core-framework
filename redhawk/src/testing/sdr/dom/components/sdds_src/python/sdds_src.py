...
# AUTO-GENERATED
#
# Source: sdds_src.spd.xml
from ossie.resource import start_component
import logging

from sdds_src_base import *

class sdds_src_i(sdds_src_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", sdds_src_i.MyMsg, self.msg_callback)
    ...
    Accessing the Device Manager and Domain Manager:
        ...
        H = bulkio.sri.create("hello")
        self.port_dataSDDS.pushSRI(H, bulkio.timestamp.now())
        return NORMAL
