...
# AUTO-GENERATED
#
# Source: logger_py.spd.xml
from ossie.resource import start_component
import logging

from logger_py_base import *

class logger_py_i(logger_py_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", logger_py_i.MyMsg, self.msg_callback)
