...
/**************************************************************************
    ...
    the ports can also be done from this class
 	...
 	Generated on: Thu Dec 20 17:19:10 EST 2012
 	Redhawk IDE
 	Version:M.1.8.2
...
PREPARE_LOGGING(TestCppPropsRange_i)

TestCppPropsRange_i::TestCppPropsRange_i(const char *uuid, const char *label) : 
    TestCppPropsRange_base(uuid, label)
{
}

TestCppPropsRange_i::~TestCppPropsRange_i()
{
}
...
/***********************************************************************************************
    ...
    Properties:
        ...
        setPropertyChangeListener(<property name>, this, &TestCppPropsRange::<callback method>)
        in the constructor.
        ...
        //Add to TestCppPropsRange.cpp
        TestCppPropsRange_i::TestCppPropsRange_i(const char *uuid, const char *label) :
            TestCppPropsRange_base(uuid, label)
        {
            setPropertyChangeListener("scaleValue", this, &TestCppPropsRange_i::scaleChanged);
        }

        void TestCppPropsRange_i::scaleChanged(const std::string& id){
            std::cout << "scaleChanged scaleValue " << scaleValue << std::endl;
        }
            
        //Add to TestCppPropsRange.h
        void scaleChanged(const std::string&);
        
        
************************************************************************************************/
int TestCppPropsRange_i::serviceFunction()
{
    LOG_DEBUG(TestCppPropsRange_i, "serviceFunction() example log message");
