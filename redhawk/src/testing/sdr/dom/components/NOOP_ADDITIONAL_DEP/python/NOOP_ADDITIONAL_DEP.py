...
# AUTO-GENERATED
#
# Source: NOOP_ADDITIONAL_DEP.spd.xml
from ossie.resource import start_component
import logging

from NOOP_ADDITIONAL_DEP_base import *

class NOOP_ADDITIONAL_DEP_i(NOOP_ADDITIONAL_DEP_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", NOOP_ADDITIONAL_DEP_i.MyMsg, self.msg_callback)
            ...
            msg_out = NOOP_ADDITIONAL_DEP_i.MyMsg()
