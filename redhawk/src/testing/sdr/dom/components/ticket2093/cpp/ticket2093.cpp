...
/**************************************************************************
    ...
    the ports can also be done from this class
     ...
     Generated on: Thu Apr 12 13:04:52 EDT 2012
     Redhawk IDE
     Version:T.1.X.X
...
#include "ticket2093.h"

PREPARE_LOGGING(ticket2093_i)

ticket2093_i::ticket2093_i(const char *uuid, const char *label) : 
    ticket2093_base(uuid, label)
{
    this->propTable.find("some_simple")->second->enableNil(true);
    this->propTable.find("some_sequence")->second->enableNil(true);
    this->propTable.find("some_struct")->second->enableNil(true);
    this->propTable.find("some_struct_seq")->second->enableNil(true);
}

ticket2093_i::~ticket2093_i()
{
}
...
************************************************************************************************/
int ticket2093_i::serviceFunction()
{
    LOG_DEBUG(ticket2093_i, "serviceFunction() example log message");
