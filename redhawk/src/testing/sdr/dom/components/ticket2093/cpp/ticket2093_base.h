...
#ifndef TICKET2093_IMPL_BASE_H
#define TICKET2093_IMPL_BASE_H
...
class ticket2093_base : public Resource_impl
{

    public: 
        ticket2093_base(const char *uuid, const char *label);
        ...
        void query(CF::Properties&) throw (CF::UnknownProperties, CORBA::SystemException);
    ...
    protected:
        ProcessThread<ticket2093_base> *serviceThread; 
        boost::mutex serviceThreadLock;  

        // Member variables exposed as properties
        short some_simple;
        std::vector<short> some_sequence;
        some_struct_struct some_struct;
        std::vector<interim_id_struct> some_struct_seq;
