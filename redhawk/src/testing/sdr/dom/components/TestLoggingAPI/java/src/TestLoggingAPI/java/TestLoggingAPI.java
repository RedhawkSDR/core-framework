 ...
 */
public class TestLoggingAPI extends TestLoggingAPI_base {
    /**
    ...
    protected int serviceFunction() {
        logger.fatal("serviceFunction() example log message - FATAL");
        logger.error("serviceFunction() example log message - ERROR ");
        logger.warn("serviceFunction() example log message - WARN ");
        logger.info("serviceFunction() example log message - INFO ");
        logger.debug("serviceFunction() example log message - DEBUG ");
        logger.trace("serviceFunction() example log message - TRACE");
