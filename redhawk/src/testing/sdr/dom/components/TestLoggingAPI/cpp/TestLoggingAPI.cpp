...
PREPARE_LOGGING(TestLoggingAPI_i)

TestLoggingAPI_i::TestLoggingAPI_i(const char *uuid, const char *label) :
    TestLoggingAPI_base(uuid, label)
{

}

TestLoggingAPI_i::~TestLoggingAPI_i()
{
}
...
/***********************************************************************************************
    ...
    Properties:
        ...
        addPropertyChangeListener(<property name>, this, &TestLoggingAPI_i::<callback method>)
        in the constructor.
        ...
        //Add to TestLoggingAPI.cpp
        TestLoggingAPI_i::TestLoggingAPI_i(const char *uuid, const char *label) :
            TestLoggingAPI_base(uuid, label)
        {
            addPropertyChangeListener("scaleValue", this, &TestLoggingAPI_i::scaleChanged);
        }

        void TestLoggingAPI_i::scaleChanged(const float *oldValue, const float *newValue)
        {
            std::cout << "scaleValue changed from" << *oldValue << " to " << *newValue
                      << std::endl;
        }
            
        //Add to TestLoggingAPI.h
