...
# AUTO-GENERATED
#
# Source: struct_prop_check.spd.xml
from ossie.resource import start_component
import logging

from struct_prop_check_base import *

class struct_prop_check_i(struct_prop_check_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", struct_prop_check_i.MyMsg, self.msg_callback)
            ...
            msg_out = struct_prop_check_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(struct_prop_check_i)
