...
from TestComplexProps_base import *

class TestComplexProps_i(TestComplexProps_base):
    ...
    def initialize(self):
        ...
        """
        TestComplexProps_base.initialize(self)
...
if __name__ == '__main__':
    ...
    start_component(TestComplexProps_i)
