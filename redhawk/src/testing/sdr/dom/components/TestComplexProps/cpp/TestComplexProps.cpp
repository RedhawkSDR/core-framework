...
PREPARE_LOGGING(TestComplexProps_i)

TestComplexProps_i::TestComplexProps_i(const char *uuid, const char *label) :
    TestComplexProps_base(uuid, label)
{
}

TestComplexProps_i::~TestComplexProps_i()
{
}
...
/***********************************************************************************************
    ...
    Properties:
        ...
        setPropertyChangeListener(<property name>, this, &TestComplexProps_i::<callback method>)
        in the constructor.
        ...
        //Add to TestComplexProps.cpp
        TestComplexProps_i::TestComplexProps_i(const char *uuid, const char *label) :
            TestComplexProps_base(uuid, label)
        {
            setPropertyChangeListener("scaleValue", this, &TestComplexProps_i::scaleChanged);
        }

        void TestComplexProps_i::scaleChanged(const std::string& id){
            std::cout << "scaleChanged scaleValue " << scaleValue << std::endl;
        }
            
        //Add to TestComplexProps.h
        void scaleChanged(const std::string&);
        
        
************************************************************************************************/
int TestComplexProps_i::serviceFunction()
{
    LOG_DEBUG(TestComplexProps_i, "serviceFunction() example log message");
