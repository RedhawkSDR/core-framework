...
class py_comp_base(CF__POA.Resource, Component, ThreadedComponent):
        ...
        # or by using the IDE.
        app_id = simple_property(id_="app_id",
                                 type_="string",
                                 mode="readonly",
                                 action="external",
                                 kinds=("configure",))
        
        number_components = simple_property(id_="number_components",
                                 type_="short",
                                 mode="readonly",
                                 action="external",
                                 kinds=("configure",))
