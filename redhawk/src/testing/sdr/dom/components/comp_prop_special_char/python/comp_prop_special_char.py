...
from comp_prop_special_char_base import *

class comp_prop_special_char_i(comp_prop_special_char_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", comp_prop_special_char_i.MyMsg, self.msg_callback)
            ...
            msg_out = comp_prop_special_char_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(comp_prop_special_char_i)
