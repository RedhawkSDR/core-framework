...
# AUTO-GENERATED
#
# Source: props_bad_numbers.spd.xml
from ossie.resource import start_component
import logging

from props_bad_numbers_base import *

class props_bad_numbers_i(props_bad_numbers_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", props_bad_numbers_i.MyMsg, self.msg_callback)
            ...
            msg_out = props_bad_numbers_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(props_bad_numbers_i)
