...
PREPARE_LOGGING(comp_i)

comp_i::comp_i(const char *uuid, const char *label) :
    comp_base(uuid, label)
{
...
/***********************************************************************************************
    ...
    Messages:
        ...
        void comp_i::my_message_callback(const std::string& id, const my_msg_struct &msg){
        }
        
        Register the message callback onto the input port with the following form:
        this->msg_input->registerMessage("my_msg", this, &comp_i::my_message_callback);
    ...
    Properties:
        ...
        addPropertyListener(<property>, this, &comp_i::<callback method>)
        in the constructor.
        ...
        comp_i::comp_i(const char *uuid, const char *label) :
            comp_base(uuid, label)
        {
            addPropertyListener(scaleValue, this, &comp_i::scaleChanged);
        }

        void comp_i::scaleChanged(const float *oldValue, const float *newValue)
        {
...
************************************************************************************************/
int comp_i::serviceFunction()
{
    LOG_DEBUG(comp_i, "serviceFunction() example log message");
