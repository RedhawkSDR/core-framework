...
from ticket_cf_1067_comp_base import *

class ticket_cf_1067_comp_i(ticket_cf_1067_comp_base):
    ...
    def initialize(self):
        ...
        """
        ticket_cf_1067_comp_base.initialize(self)
...
if __name__ == '__main__':
    ...
    start_component(ticket_cf_1067_comp_i)
