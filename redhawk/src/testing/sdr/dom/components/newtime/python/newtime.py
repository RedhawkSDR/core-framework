...
# AUTO-GENERATED
#
# Source: newtime.spd.xml
from ossie.resource import start_component
import logging

from newtime_base import *

class newtime_i(newtime_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", newtime_i.MyMsg, self.msg_callback)
