...
PREPARE_LOGGING(huge_msg_cpp_i)

huge_msg_cpp_i::huge_msg_cpp_i(const char *uuid, const char *label) :
    huge_msg_cpp_base(uuid, label)
{
    // Avoid placing constructor code here. Instead, use the "constructor" function.

}

huge_msg_cpp_i::~huge_msg_cpp_i()
{
}

void huge_msg_cpp_i::constructor()
{
    /***********************************************************************************
...
/***********************************************************************************************
    ...
    Messages:
        ...
        void huge_msg_cpp_i::my_message_callback(const std::string& id, const my_msg_struct &msg){
        }
        
        Register the message callback onto the input port with the following form:
        this->msg_input->registerMessage("my_msg", this, &huge_msg_cpp_i::my_message_callback);
    ...
    Properties:
        ...
        addPropertyListener(<property>, this, &huge_msg_cpp_i::<callback method>)
        in the constructor.
        ...
        //Add to huge_msg_cpp.cpp
        huge_msg_cpp_i::huge_msg_cpp_i(const char *uuid, const char *label) :
            huge_msg_cpp_base(uuid, label)
        {
            addPropertyListener(scaleValue, this, &huge_msg_cpp_i::scaleChanged);
            addPropertyListener(status, this, &huge_msg_cpp_i::statusChanged);
        }

        void huge_msg_cpp_i::scaleChanged(float oldValue, float newValue)
        {
            LOG_DEBUG(huge_msg_cpp_i, "scaleValue changed from" << oldValue << " to " << newValue);
        }
            
        void huge_msg_cpp_i::statusChanged(const status_struct& oldValue, const status_struct& newValue)
        {
            LOG_DEBUG(huge_msg_cpp_i, "status changed");
        }
            
        //Add to huge_msg_cpp.h
...
************************************************************************************************/
int huge_msg_cpp_i::serviceFunction()
{
