...
# AUTO-GENERATED
#
# Source: math_py.spd.xml
from ossie.resource import start_component
import logging

from math_py_base import *

class math_py_i(math_py_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", math_py_i.MyMsg, self.msg_callback)
