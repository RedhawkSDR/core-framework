...
# AUTO-GENERATED
#
# Source: hanging_stop.spd.xml
from ossie.resource import start_component
import logging

from hanging_stop_base import *

class hanging_stop_i(hanging_stop_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", hanging_stop_i.MyMsg, self.msg_callback)
...
if __name__ == '__main__':
    ...
    start_component(hanging_stop_i)
