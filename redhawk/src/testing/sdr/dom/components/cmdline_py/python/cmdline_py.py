...
# AUTO-GENERATED
#
# Source: cmdline_py.spd.xml
from ossie.resource import start_component
import logging

from cmdline_py_base import *

class cmdline_py_i(cmdline_py_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", cmdline_py_i.MyMsg, self.msg_callback)
