...
# AUTO-GENERATED
#
# Source: py_prop_writeonly.spd.xml
from ossie.resource import start_component
import logging

from py_prop_writeonly_base import *

class py_prop_writeonly_i(py_prop_writeonly_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", py_prop_writeonly_i.MyMsg, self.msg_callback)
            ...
            msg_out = py_prop_writeonly_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(py_prop_writeonly_i)
