...
import spdNestedDepLibrary
import spdDepLibrary
import spdNested2DepLibrary

class CommandWrapperNestedSPDDep_i(CF__POA.Resource, Resource):
...
if __name__ == '__main__':
    ...
    start_component(CommandWrapperNestedSPDDep_i)
