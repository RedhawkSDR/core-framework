...
from PropertyChange_P1_base import *

class PropertyChange_P1_i(PropertyChange_P1_base):
    ...
    def initialize(self):
        ...
        """
        PropertyChange_P1_base.initialize(self)
...
if __name__ == '__main__':
    ...
    start_component(PropertyChange_P1_i)
