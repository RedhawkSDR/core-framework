...
from msg_through_base import *

class msg_through_i(msg_through_base):
    ...
    def constructor(self):
        ...
        """
        self.port_input.registerMessage("foo", msg_through_i.Foo, self.msg_callback)
            
    def msg_callback(self, msg_id, msg_value):
        self.port_output.sendMessage(msg_value)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", msg_through_i.MyMsg, self.msg_callback)
