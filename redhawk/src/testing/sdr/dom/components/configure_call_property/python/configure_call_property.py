...
# AUTO-GENERATED
#
# Source: configure_call_property.spd.xml
from ossie.resource import start_component
import logging

from configure_call_property_base import *

class configure_call_property_i(configure_call_property_base):
    ...
    def configure(self, props):
        configure_call_property_base.configure(self, props)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", configure_call_property_i.MyMsg, self.msg_callback)
            ...
            msg_out = configure_call_property_i.MyMsg()
