...
#Sun ORB start line
exec $JAVA -cp :../../../../../base/framework/java/ossie.jar:../../../../../base/framework/java/log4j-1.2.15.jar:../../../../../base/framework/java/CFInterfaces.jar:$myDir/EventReceive_java_impl1.jar:$myDir/bin:$CLASSPATH EventReceive_java_impl1.EventReceive_java_impl1 "$@"
