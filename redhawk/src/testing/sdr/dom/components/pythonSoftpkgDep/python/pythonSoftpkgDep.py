...
# AUTO-GENERATED
#
# Source: pythonSoftpkgDep.spd.xml
from ossie.resource import start_component
import logging

from pythonSoftpkgDep_base import *

class pythonSoftpkgDep_i(pythonSoftpkgDep_base):
    ...
    def constructor(self):
        ...
        """
        import helloworld
        self.h1 = helloworld.HelloWorld()
        from helloworld2 import helloworld2
        self.h2 = helloworld2.HelloWorld()
        from helloworld3 import helloworld3
        self.h3 = helloworld3.HelloWorld()
        
    def start(self):
        pythonSoftpkgDep_base.start(self)
        self.prop1 = self.h1.c['goober']
        self.prop2 = self.h2.c['jones']
        self.prop3 = ' '.join(sorted(self.h3.c.keys()))
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", pythonSoftpkgDep_i.MyMsg, self.msg_callback)
            ...
            msg_out = pythonSoftpkgDep_i.MyMsg()
