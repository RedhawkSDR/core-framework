...
from Property_PY_base import *

class Property_PY_i(Property_PY_base):
    ...
    def initialize(self):
        ...
        """
        Property_PY_base.initialize(self)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", Property_PY_i.MyMsg, self.msg_callback)
