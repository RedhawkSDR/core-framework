...
class ComponentTests(ossie.utils.testing.ScaComponentTestCase):
    """Test for all component implementations in PropertyChangeEventsJava"""
...
if __name__ == "__main__":
    ossie.utils.testing.main("../PropertyChangeEventsJava.spd.xml") # By default tests all implementations
