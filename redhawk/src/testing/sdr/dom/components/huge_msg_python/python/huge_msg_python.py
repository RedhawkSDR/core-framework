...
# AUTO-GENERATED
#
# Source: huge_msg_python.spd.xml
from ossie.resource import start_component
import logging

from huge_msg_python_base import *

class huge_msg_python_i(huge_msg_python_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", huge_msg_python_i.MyMsg, self.msg_callback)
            ...
            msg_out = huge_msg_python_i.MyMsg()
    ...
    Accessing the Device Manager and Domain Manager:
        ...
        msg = huge_msg_python_base.MyMsg()
        payload = "1234567890"
        str_msg = payload
...
if __name__ == '__main__':
    ...
    start_component(huge_msg_python_i)
