...
# AUTO-GENERATED
#
# Source: timeprop_py.spd.xml
from ossie.resource import start_component
import logging

from timeprop_py_base import *

class timeprop_py_i(timeprop_py_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", timeprop_py_i.MyMsg, self.msg_callback)
