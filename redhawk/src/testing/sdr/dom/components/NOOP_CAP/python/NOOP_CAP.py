...
# Generated on: Fri Oct 26 12:54:33 EDT 2012
# Redhawk IDE
# Version:@buildLabel@
# Build id: @buildId@
...
from NOOP_CAP_base import * 

class NOOP_CAP_i(NOOP_CAP_base):
