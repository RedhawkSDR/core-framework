...
from TestPythonOptionalProps_base import *

class TestPythonOptionalProps_i(TestPythonOptionalProps_base):
    ...
    def initialize(self):
        ...
        """
        TestPythonOptionalProps_base.initialize(self)
...
if __name__ == '__main__':
    ...
    start_component(TestPythonOptionalProps_i)
