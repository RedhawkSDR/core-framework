...
class CppHierarchicalDomainLogging(scatest.CorbaTestCase):
    ...
    def test_logconfiguri_application(self):
        ...
        self.assertEqual(app_1.getLogLevel('logger_1'), 30000)
        self.assertEqual(app_1.getLogLevel('logger_2'), 30000)
        ...
        self.assertEqual(app_1.getLogLevel('logger_1'), 30000)
        self.assertEqual(app_1.getLogLevel('logger_2'), 30000)
        self.assertEqual(app_2.getLogLevel('logger_1'), 40000)
        self.assertEqual(app_2.getLogLevel('logger_2'), 40000)
    ...
    def test_loggingconfig(self):
        ...
        self.assertEqual(app_1.getLogLevel('logger_1'), 0)
        self.assertEqual(app_1.getLogLevel('logger_2'), 50000)
        logger_1 = -1
        logger_2 = -1
        ...
        self.assertEqual(app_1.comps[logger_1].getLogConfig(), high_thresh_cfg)
        self.assertEqual(app_1.comps[logger_2].getLogConfig(), runtest_props)
        ...
        loggers_2 = app_2.getNamedLoggers()
        self.assertEqual(app_2.getLogLevel('logger_1'), 30000)
        self.assertEqual(app_2.getLogLevel('logger_2'), 30000)
        self.assertEqual(app_2.comps[logger_1].getLogConfig(), high_thresh_cfg)
        self.assertEqual(app_2.comps[logger_2].getLogConfig(), high_thresh_cfg)
        app_1.start()
        time.sleep(1.5)
    ...
    def applicationAccess(self, sadfile):
        ...
        self.assertEqual(app.getLogLevel(self.cname+'_1'), CF.LogLevels.ALL)
        self.assertEqual(app.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.ALL)
        self.assertEqual(app.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.ALL)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.ALL)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.ALL)
        app.setLogLevel(self.cname+'_1', 'off')
        self.assertEqual(app.getLogLevel(self.cname+'_1'), CF.LogLevels.OFF)
        self.assertEqual(app.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.OFF)
        self.assertEqual(app.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.OFF)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.OFF)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.OFF)
        ...
        self.assertEqual(app.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.ALL)
        self.assertEqual(app.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.ALL)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.TRACE)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.TRACE)

        # set the log with a value rather than the string
        app.setLogLevel(self.cname+'_1', CF.LogLevels.DEBUG)
        self.assertEqual(app.getLogLevel(self.cname+'_1'), CF.LogLevels.DEBUG)
        self.assertEqual(app.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.DEBUG)
        self.assertEqual(app.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.DEBUG)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.TRACE)
        self.assertEqual(app.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.TRACE)

        app.resetLog()
        self.assertEqual(orig_loggers[self.cname+'_1'], app.getLogLevel(self.cname+'_1'))
        self.assertEqual(orig_loggers[self.cname+'_1.lower'], app.getLogLevel(self.cname+'_1.lower'))
        self.assertEqual(orig_loggers[self.cname+'_1.namespace.lower'], app.getLogLevel(self.cname+'_1.namespace.lower'))
        self.assertEqual(orig_loggers[self.cname+'_1.user.more_stuff'], app.getLogLevel(self.cname+'_1.user.more_stuff'))
        self.assertEqual(orig_loggers[self.cname+'_1.user.some_stuff'], app.getLogLevel(self.cname+'_1.user.some_stuff'))

        # verify that inheritance is re-established
        app.setLogLevel(self.cname+'_1', 'all')
        self.assertEqual(CF.LogLevels.ALL, app.getLogLevel(self.cname+'_1'))
        self.assertEqual(CF.LogLevels.ALL, app.getLogLevel(self.cname+'_1.lower'))
        self.assertEqual(CF.LogLevels.ALL, app.getLogLevel(self.cname+'_1.namespace.lower'))
        self.assertEqual(CF.LogLevels.ALL, app.getLogLevel(self.cname+'_1.user.more_stuff'))
        self.assertEqual(CF.LogLevels.ALL, app.getLogLevel(self.cname+'_1.user.some_stuff'))
...
def all_log_levels(_obj):
    ...
    time.sleep(0.5)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1'), CF.LogLevels.ALL)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.lower'), CF.LogLevels.ALL)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.lower.second.first'), CF.LogLevels.ALL)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.lower.third'), CF.LogLevels.ALL)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.namespace.lower'), CF.LogLevels.ALL)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.user.more_stuff'), CF.LogLevels.ALL)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.user.some_stuff'), CF.LogLevels.ALL)
    ...
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.user.some_stuff'), CF.LogLevels.OFF)
    ...
    _obj.assertEqual(len(content), len(content_again))
    ...
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.user.some_stuff'), CF.LogLevels.TRACE)
    ...
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.lower.second.first'), CF.LogLevels.DEBUG)
...
def reset_logger(_obj):
    ...
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1'), CF.LogLevels.OFF)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.lower'), CF.LogLevels.OFF)
    _obj.assertEqual(_obj.comp.getLogLevel(_obj.cname+'_1.lower.second.first'), CF.LogLevels.OFF)
    ...
    _obj.comp.resetLog()
    _obj.assertEqual(orig_loggers[_obj.cname+'_1'], _obj.comp.getLogLevel(_obj.cname+'_1'))
    _obj.assertEqual(orig_loggers[_obj.cname+'_1.lower'], _obj.comp.getLogLevel(_obj.cname+'_1.lower'))
    _obj.assertEqual(orig_loggers[_obj.cname+'_1.lower.second.first'], _obj.comp.getLogLevel(_obj.cname+'_1.lower.second.first'))
    _obj.assertEqual(orig_loggers[_obj.cname+'_1.lower.third'], _obj.comp.getLogLevel(_obj.cname+'_1.lower.third'))
    _obj.assertEqual(orig_loggers[_obj.cname+'_1.namespace.lower'], _obj.comp.getLogLevel(_obj.cname+'_1.namespace.lower'))
    _obj.assertEqual(orig_loggers[_obj.cname+'_1.user.more_stuff'], _obj.comp.getLogLevel(_obj.cname+'_1.user.more_stuff'))
    _obj.assertEqual(orig_loggers[_obj.cname+'_1.user.some_stuff'], _obj.comp.getLogLevel(_obj.cname+'_1.user.some_stuff'))

    # verify that inheritance is re-established
    _obj.comp.setLogLevel(_obj.cname+'_1', 'all')
    _obj.assertEqual(CF.LogLevels.ALL, _obj.comp.getLogLevel(_obj.cname+'_1'))
    _obj.assertEqual(CF.LogLevels.ALL, _obj.comp.getLogLevel(_obj.cname+'_1.lower'))
    _obj.assertEqual(CF.LogLevels.ALL, _obj.comp.getLogLevel(_obj.cname+'_1.lower.second.first'))
    _obj.assertEqual(CF.LogLevels.ALL, _obj.comp.getLogLevel(_obj.cname+'_1.lower.third'))
    _obj.assertEqual(CF.LogLevels.ALL, _obj.comp.getLogLevel(_obj.cname+'_1.namespace.lower'))
    _obj.assertEqual(CF.LogLevels.ALL, _obj.comp.getLogLevel(_obj.cname+'_1.user.more_stuff'))
    _obj.assertEqual(CF.LogLevels.ALL, _obj.comp.getLogLevel(_obj.cname+'_1.user.some_stuff'))
...
def selective_log_setting(_obj):
    ...
    _obj.assertEqual(_obj.comp.getLogLevel('logger_1.user.more_stuff'), CF.LogLevels.ALL)
    _obj.assertEqual(_obj.comp.getLogLevel('logger_1.user.some_stuff'), CF.LogLevels.WARN)
    _obj.assertEqual(_obj.comp.getLogLevel('logger_1.namespace.lower'), CF.LogLevels.TRACE)
    time.sleep(0.5)
    _obj.comp.stop()
    ...
    _obj.assertEqual(count_test, count_newline-count_log4cxx_test-count_java_eventchannel_messages)
    _obj.assertEqual(count_logger_test, count_logger_newline)
...
class CppDeviceHierarchicalDomainLogging(scatest.CorbaTestCase):
    ...
    def test_domMgr_log_level(self):
        ...
        self.assertEqual(self._rhDom.getLogLevel('DomainManager'),current_level)
        self.assertEqual(self._rhDom.getLogLevel('DomainManager.AllocationManager'),current_level)
        self.assertEqual(self._rhDom.getLogLevel('DomainManager.ConnectionManager'),current_level)
        self.assertEqual(self._rhDom.getLogLevel('DomainManager.File'),current_level)
        self.assertEqual(self._rhDom.getLogLevel('DomainManager.FileManager'),current_level)
        self.assertEqual(self._rhDom.getLogLevel('DomainManager.proputils'),current_level)
        self.assertEqual(self._rhDom.getLogLevel('DomainManager.EventChannelManager'),current_level)
    ...
    def devMgrAccess(self, dcdfile):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 1)
        # Create Application from $SDRROOT path
        ...
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1'), CF.LogLevels.ALL)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.ALL)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.ALL)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.ALL)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.ALL)
        devMgr.setLogLevel(self.cname+'_1', 'off')
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1'), CF.LogLevels.OFF)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.OFF)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.OFF)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.OFF)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.OFF)
        ...
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.ALL)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.ALL)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.TRACE)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.TRACE)

        # set the log with a value rather than the string
        devMgr.setLogLevel(self.cname+'_1', CF.LogLevels.DEBUG)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1'), CF.LogLevels.DEBUG)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.lower'), CF.LogLevels.DEBUG)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.namespace.lower'), CF.LogLevels.DEBUG)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.more_stuff'), CF.LogLevels.TRACE)
        self.assertEqual(devMgr.getLogLevel(self.cname+'_1.user.some_stuff'), CF.LogLevels.TRACE)

        devMgr.resetLog()
        self.assertEqual(orig_loggers[self.cname+'_1'], devMgr.getLogLevel(self.cname+'_1'))
        self.assertEqual(orig_loggers[self.cname+'_1.lower'], devMgr.getLogLevel(self.cname+'_1.lower'))
        self.assertEqual(orig_loggers[self.cname+'_1.namespace.lower'], devMgr.getLogLevel(self.cname+'_1.namespace.lower'))
        self.assertEqual(orig_loggers[self.cname+'_1.user.more_stuff'], devMgr.getLogLevel(self.cname+'_1.user.more_stuff'))
        self.assertEqual(orig_loggers[self.cname+'_1.user.some_stuff'], devMgr.getLogLevel(self.cname+'_1.user.some_stuff'))

        # verify that inheritance is re-established
        devMgr.setLogLevel(self.cname+'_1', 'all')
        self.assertEqual(CF.LogLevels.ALL, devMgr.getLogLevel(self.cname+'_1'))
        self.assertEqual(CF.LogLevels.ALL, devMgr.getLogLevel(self.cname+'_1.lower'))
        self.assertEqual(CF.LogLevels.ALL, devMgr.getLogLevel(self.cname+'_1.namespace.lower'))
        self.assertEqual(CF.LogLevels.ALL, devMgr.getLogLevel(self.cname+'_1.user.more_stuff'))
        self.assertEqual(CF.LogLevels.ALL, devMgr.getLogLevel(self.cname+'_1.user.some_stuff'))
    ...
    def test_devMgr_overload(self):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 2)
        # Create Application from $SDRROOT path
        _devMgr_o = None
        _devMgr = None
        ...
        self.assertEqual(_devMgr_o.getLogLevel('log_test_cpp_1'), 40000)
        self.assertEqual(_devMgr_o.getLogLevel('log_test_cpp_2'), 30000)
        self.assertEqual(_devMgr.getLogLevel('log_test_cpp_1'), 40000)
        self.assertEqual(_devMgr.getLogLevel('log_test_cpp_2'), 40000)
    ...
    def test_devMgr_level_trace(self):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 1)
        self.assertEqual(self._rhDom.devMgrs[0]._get_log_level(), CF.LogLevels.ALL) # CF ALL and CF TRACE overlap for compatibility reasons
        self.assertEqual(self._rhDom.devMgrs[0].devs[0]._get_log_level(), CF.LogLevels.ALL)
    ...
    def test_devMgr_level_debug(self):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 1)
        self.assertEqual(self._rhDom.devMgrs[0]._get_log_level(), CF.LogLevels.DEBUG)
        self.assertEqual(self._rhDom.devMgrs[0].devs[0]._get_log_level(), CF.LogLevels.DEBUG)
    ...
    def test_devMgr_level_info(self):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 1)
        self.assertEqual(self._rhDom.devMgrs[0]._get_log_level(), CF.LogLevels.INFO)
        self.assertEqual(self._rhDom.devMgrs[0].devs[0]._get_log_level(), CF.LogLevels.INFO)
    ...
    def test_devMgr_level_warn(self):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 1)
        self.assertEqual(self._rhDom.devMgrs[0]._get_log_level(), CF.LogLevels.WARN)
        self.assertEqual(self._rhDom.devMgrs[0].devs[0]._get_log_level(), CF.LogLevels.WARN)
    ...
    def test_devMgr_level_error(self):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 1)
        self.assertEqual(self._rhDom.devMgrs[0]._get_log_level(), CF.LogLevels.ERROR)
        self.assertEqual(self._rhDom.devMgrs[0].devs[0]._get_log_level(), CF.LogLevels.ERROR)
    ...
    def test_devMgr_level_fatal(self):
        ...
        self._rhDom = redhawk.attach(scatest.getTestDomainName())
        self.assertEqual(len(self._rhDom.devMgrs), 1)
        self.assertEqual(self._rhDom.devMgrs[0]._get_log_level(), CF.LogLevels.FATAL)
        self.assertEqual(self._rhDom.devMgrs[0].devs[0]._get_log_level(), CF.LogLevels.FATAL)
