...
class UnitTestTest(scatest.OssieTestCase):
    ...
    def test_GetPropertySet(self):
        ...
        self.assertEqual("EXEC_PARAM_1" in execparams, True)
        self.assertEqual("EXEC_PARAM_2" in execparams, True)
        self.assertEqual("EXEC_PARAM_4" in execparams, True)
        self.assertEqual("SOMEOBJREF" in execparams, True)
        ...
        self.assertEqual("EXEC_PARAM_2" in execparams, True)
        self.assertEqual("EXEC_PARAM_4" in execparams, True)
        self.assertEqual("SOMEOBJREF" in execparams, False)
        ...
        self.assertEqual("DCE:a4e7b230-1d17-4a86-aeff-ddc6ea3df26e" in cfgparams, True)
        self.assertEqual("DCE:5d8bfe8d-bc25-4f26-8144-248bc343aa53" in cfgparams, True)
        self.assertEqual("DCE:ffe634c9-096d-425b-86cc-df1cce50612f" in cfgparams, True)
        self.assertEqual("DCE:fa8c5924-845c-484a-81df-7941f2c5baa9" in cfgparams, True)
        self.assertEqual("DCE:a7de97ee-1e78-45e9-8e2b-204c141656fc" in cfgparams, True)
        self.assertEqual("DCE:9ec6e2ff-6a4f-4452-8f38-4df47d6eebc1" in cfgparams, True)
        self.assertEqual("DCE:cf623573-a09d-4fb1-a2ae-24b0b507115d" in cfgparams, True)
        self.assertEqual("DCE:6ad84383-49cf-4017-b7ca-0ec4c4917952" in cfgparams, True)
        ...
        self.assertEqual("configure_prop_notset" in propparams, True)
