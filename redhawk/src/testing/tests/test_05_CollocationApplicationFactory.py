...
class ComplexApplicationFactoryTest(scatest.CorbaTestCase):
    ...
    def test_collocationFailed(self):
        ...
        nodebooter, devMgr = self.launchDeviceManager("/nodes/test_collocation_node1_2dev1cap/DeviceManager.dcd.xml", debug=9)

        self.assertNotEqual(devMgr, None)

        nodebooter, devMgr = self.launchDeviceManager("/nodes/test_collocation_node2_2dev1cap/DeviceManager.dcd.xml", debug=9)
    ...
    def test_collocationSuccess(self):
        ...
        nodebooter, devMgr = self.launchDeviceManager("/nodes/test_collocation_node1_2dev2cap/DeviceManager.dcd.xml", debug=9)
    ...
    def test_collocationLastSuccessfulDevice(self):
        ...
        nodebooter, devMgr = self.launchDeviceManager("/nodes/test_collocation_good_node/DeviceManager.dcd.xml", debug=3)
        self.assertNotEqual(devMgr, None)
