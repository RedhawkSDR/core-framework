...
#{% endif %}
    ...
    def hwLoadRequest(self):
        request = []
        request.append(CF.DataType("hw_load_request::request_id", str(uuid.uuid4())))
        request.append(CF.DataType("hw_load_request::requester_id", self._get_identifier()))
        request.append(CF.DataType("hw_load_request::hardware_id", "some_hardware_id"))
        request.append(CF.DataType("hw_load_request::load_filepath", "/path/to/some/load/file"))
        return request
