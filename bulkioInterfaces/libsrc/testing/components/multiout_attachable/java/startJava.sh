...
classpath=$myDir/multiout_attachable.jar:$myDir/bin:$bulkio_libsrc_top/bulkio.jar:$bulkio_top/BULKIOInterfaces.jar
...
exec java -cp $classpath:$CLASSPATH multiout_attachable.java.multiout_attachable "$@"
