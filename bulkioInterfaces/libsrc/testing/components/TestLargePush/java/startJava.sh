...
classpath=$myDir/TestLargePush.jar:$myDir/bin:$bulkio_libsrc_top/bulkio.jar:$bulkio_top/BULKIOInterfaces.jar
...
exec java -cp $classpath:$CLASSPATH TestLargePush.java.TestLargePush "$@"
