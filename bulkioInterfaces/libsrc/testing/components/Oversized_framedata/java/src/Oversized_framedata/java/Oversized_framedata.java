 ...
 */
public class Oversized_framedata extends Oversized_framedata_base {
    /**
    ...
    protected int serviceFunction() {
        ...
        short[] data = new short[20000000];
        BULKIO.PrecisionUTCTime tstamp = bulkio.time.utils.now();
        this.port_dataShort_out.pushPacket(data, tstamp, true, stream_id);
