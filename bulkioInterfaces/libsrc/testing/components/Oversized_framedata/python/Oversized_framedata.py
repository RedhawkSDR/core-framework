...
from Oversized_framedata_base import *

class Oversized_framedata_i(Oversized_framedata_base):
    ...
    def initialize(self):
        ...
        """
        Oversized_framedata_base.initialize(self)
        self.sri = None
...
if __name__ == '__main__':
    ...
    start_component(Oversized_framedata_i)
