...
classpath=$myDir/dev_src.jar:$myDir/bin:$bulkio_libsrc_top/bulkio.jar:$bulkio_top/BULKIOInterfaces.jar
...
exec java -cp $classpath:$CLASSPATH dev_src.java.dev_src "$@"
