...
public class MultiOutUInt16_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InUInt16Port ip1 = null;
    bulkio.InUInt16Port ip2 = null;
    bulkio.InUInt16Port ip3 = null;
    bulkio.InUInt16Port ip4 = null;
    bulkio.OutUInt16Port port = null;
    ...
    @Before
	public void setUp() {
	ip1 = new bulkio.InUInt16Port("sink_1",logger);
	ip2 = new bulkio.InUInt16Port("sink_2", logger );
	ip3 = new bulkio.InUInt16Port("sink_3", logger );
	ip4 = new bulkio.InUInt16Port("sink_4", logger );
	port = new bulkio.OutUInt16Port("multiout_source", logger );
	...
	bulkio.InUInt16Port.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
	...
	BULKIO.StreamSRI asri;
	BULKIO.StreamSRI []streams;
	short[] v = new short[91];
	bulkio.InUInt16Port.Packet pkt;
