...
public class MultiOutInt8_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InInt8Port ip1 = null;
    bulkio.InInt8Port ip2 = null;
    bulkio.InInt8Port ip3 = null;
    bulkio.InInt8Port ip4 = null;
    bulkio.OutInt8Port port = null;
    ...
    @Before
	public void setUp() {
	ip1 = new bulkio.InInt8Port("sink_1",logger);
	ip2 = new bulkio.InInt8Port("sink_2", logger );
	ip3 = new bulkio.InInt8Port("sink_3", logger );
	ip4 = new bulkio.InInt8Port("sink_4", logger );
	port = new bulkio.OutInt8Port("multiout_source", logger );
	...
	bulkio.InInt8Port.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
