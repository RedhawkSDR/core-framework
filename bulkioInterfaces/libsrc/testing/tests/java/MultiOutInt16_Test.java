...
public class MultiOutInt16_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InInt16Port ip1 = null;
    bulkio.InInt16Port ip2 = null;
    bulkio.InInt16Port ip3 = null;
    bulkio.InInt16Port ip4 = null;
    bulkio.OutInt16Port port = null;
    ...
    @Before
	public void setUp() {
	ip1 = new bulkio.InInt16Port("sink_1",logger);
	ip2 = new bulkio.InInt16Port("sink_2", logger );
	ip3 = new bulkio.InInt16Port("sink_3", logger );
	ip4 = new bulkio.InInt16Port("sink_4", logger );
	port = new bulkio.OutInt16Port("multiout_source", logger );
	...
	bulkio.InInt16Port.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
