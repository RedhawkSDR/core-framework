...
public class MultiOutInt32_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InInt32Port ip1 = null;
    bulkio.InInt32Port ip2 = null;
    bulkio.InInt32Port ip3 = null;
    bulkio.InInt32Port ip4 = null;
    bulkio.OutInt32Port port = null;
    ...
    @Before
	public void setUp() {
	ip1 = new bulkio.InInt32Port("sink_1",logger);
	ip2 = new bulkio.InInt32Port("sink_2", logger );
	ip3 = new bulkio.InInt32Port("sink_3", logger );
	ip4 = new bulkio.InInt32Port("sink_4", logger );
	port = new bulkio.OutInt32Port("multiout_source", logger );
	...
	bulkio.InInt32Port.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
