...
public class MultiOutUInt64_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InUInt64Port ip1 = null;
    bulkio.InUInt64Port ip2 = null;
    bulkio.InUInt64Port ip3 = null;
    bulkio.InUInt64Port ip4 = null;
    bulkio.OutUInt64Port port = null;
    ...
    @Before
	public void setUp() {
	ip1 = new bulkio.InUInt64Port("sink_1",logger);
	ip2 = new bulkio.InUInt64Port("sink_2", logger );
	ip3 = new bulkio.InUInt64Port("sink_3", logger );
	ip4 = new bulkio.InUInt64Port("sink_4", logger );
	port = new bulkio.OutUInt64Port("multiout_source", logger );
	...
	bulkio.InUInt64Port.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
	...
	BULKIO.StreamSRI []streams;
	long[] v = new long[91];
	bulkio.InUInt64Port.Packet pkt;
