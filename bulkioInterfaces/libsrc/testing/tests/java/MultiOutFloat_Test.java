...
public class MultiOutFloat_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InFloatPort ip1 = null;
    bulkio.InFloatPort ip2 = null;
    bulkio.InFloatPort ip3 = null;
    bulkio.InFloatPort ip4 = null;
    bulkio.OutFloatPort port = null;
	...
	bulkio.InFloatPort.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
	...
	BULKIO.StreamSRI asri;
	BULKIO.StreamSRI []streams;
	float[] v = new float[91];
	bulkio.InFloatPort.Packet pkt;
