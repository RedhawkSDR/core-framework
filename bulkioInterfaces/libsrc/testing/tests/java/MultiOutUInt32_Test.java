...
public class MultiOutUInt32_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InUInt32Port ip1 = null;
    bulkio.InUInt32Port ip2 = null;
    bulkio.InUInt32Port ip3 = null;
    bulkio.InUInt32Port ip4 = null;
    bulkio.OutUInt32Port port = null;
    ...
    @Before
	public void setUp() {
	ip1 = new bulkio.InUInt32Port("sink_1",logger);
	ip2 = new bulkio.InUInt32Port("sink_2", logger );
	ip3 = new bulkio.InUInt32Port("sink_3", logger );
	ip4 = new bulkio.InUInt32Port("sink_4", logger );
	port = new bulkio.OutUInt32Port("multiout_source", logger );
	...
	bulkio.InUInt32Port.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
	...
	BULKIO.StreamSRI []streams;
	int[] v = new int[91];
	bulkio.InUInt32Port.Packet pkt;
