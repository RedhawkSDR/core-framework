...
public class OutXMLStreamTest {

    /**
     * Input port being tested
     */
    protected OutXMLPort port;
     ...
     */
    protected BULKIO.dataXMLOperations corbaPort;

    protected XMLTestHelper helper;

    public OutXMLStreamTest()
    {
        this.helper = new XMLTestHelper();
    }
    ...
    protected void _writeSinglePacket(OutXMLStream stream, int size)
    {
    ...
    protected void _writeSinglePacket(OutXMLStream stream, int size, BULKIO.PrecisionUTCTime time)
    {
    ...
    {
        // Create a new stream
        OutXMLStream good_stream = this.port.createStream("test_operators");
        Assert.assertNotNull(good_stream);

        // Get another handle to the same stream, should be equal
        OutXMLStream same_stream = port.getStream("test_operators");
        Assert.assertEquals(same_stream, good_stream);

        // Create a new stream, should not be equal
        OutXMLStream other_stream = port.createStream("test_operators_2");
    ...
    {
        OutXMLStream stream = port.createStream("test_basic_write");
    ...
    public void testSriFields()
    {
        ...
        OutXMLStream stream = port.createStream(sri);
    ...
    public void testSriNoChange()
    {
        ...
        OutXMLStream stream = port.createStream("test_sri_no_change");
    ...
    public void testSriUpdate()
    {
        ...
        // write
        OutXMLStream stream = port.createStream("test_sri_update");
    ...
    {
        OutXMLStream stream = port.createStream("test_keywords");
    ...
    {
        OutXMLStream stream = port.createStream("close_eos");
