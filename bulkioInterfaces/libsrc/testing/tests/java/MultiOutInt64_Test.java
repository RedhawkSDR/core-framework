...
public class MultiOutInt64_Test {

    Logger logger =  Logger.getRootLogger();

    public static ORB orb;

    bulkio.InInt64Port ip1 = null;
    bulkio.InInt64Port ip2 = null;
    bulkio.InInt64Port ip3 = null;
    bulkio.InInt64Port ip4 = null;
    bulkio.OutInt64Port port = null;
    ...
    @Before
	public void setUp() {
	ip1 = new bulkio.InInt64Port("sink_1",logger);
	ip2 = new bulkio.InInt64Port("sink_2", logger );
	ip3 = new bulkio.InInt64Port("sink_3", logger );
	ip4 = new bulkio.InInt64Port("sink_4", logger );
	port = new bulkio.OutInt64Port("multiout_source", logger );
	...
	bulkio.InInt64Port.Packet pkt = ip1.getPacket( bulkio.Const.NON_BLOCKING );
