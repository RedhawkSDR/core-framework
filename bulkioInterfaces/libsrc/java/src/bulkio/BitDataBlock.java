...
public class BitDataBlock
{
    ...
    protected bitbuffer _data;
    protected SampleTimestamp[] _timestamps;
    protected int _sriChangeFlags;
    protected boolean _inputQueueFlushed;

    public BitDataBlock(BULKIO.StreamSRI sri, bitbuffer data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public void setBuffer(bitbuffer new_buffer)
    {
