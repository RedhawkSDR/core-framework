...
public class OutXMLStream extends OutStreamBase {

    protected OutXMLPort _port;

    public OutXMLStream(BULKIO.StreamSRI sri, OutXMLPort port) {
        super(sri);
        this._port = port;
    };
    ...
    protected void _writeMultiple(String data, boolean eos) {
        if (this.checkSRI()) {
            this._port.pushSRI(this._sri);
        }
        this._port.pushPacket(data, eos, this._sri.streamID);
    };
    ...
    public void write(String data) {
        this._writeMultiple(data, false);
    };

    public void close() {
        String data = new String();
        this._writeMultiple(data, true);
    };
};
