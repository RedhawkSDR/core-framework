...
class SRDC_base(CF__POA.Device, FrontendTunerDevice, digital_tuner_delegation, rfinfo_delegation, ThreadedComponent, DynamicComponent):
...
class PortCFDeviceStatusOut_i(SRDC_base.PortCFDeviceStatusOut):
