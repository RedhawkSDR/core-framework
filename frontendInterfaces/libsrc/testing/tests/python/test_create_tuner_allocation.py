...
class ValidateRequestTest(unittest.TestCase):
    ...
    def testFrontendAllocationStruct(self):
        ...
        self.assertEqual(frontend_allocation['FRONTEND::tuner_allocation']['FRONTEND::tuner_allocation::allocation_id'], 'hello')
        self.assertEqual(frontend_allocation['FRONTEND::tuner_allocation']['FRONTEND::tuner_allocation::device_control'], True)
        self.assertEqual(frontend_allocation['FRONTEND::tuner_allocation']['FRONTEND::tuner_allocation::center_frequency'], 30000000)
        self.assertEqual(frontend_allocation['FRONTEND::tuner_allocation']['FRONTEND::tuner_allocation::bandwidth_tolerance'], 100)
