...
import FRONTEND.DigitalScanningTunerOperations;
...
public class OutDigitalScanningTunerPort extends QueryableUsesPort<DigitalScanningTunerOperations> implements PortBase {

    /**
     * Map of connection Ids to port objects
     */
    protected Map<String, DigitalScanningTunerOperations> outConnections = new HashMap<String, DigitalScanningTunerOperations>();

    public OutDigitalScanningTunerPort(String portName) {
        super(portName);
        this.outConnections = new HashMap<String, DigitalScanningTunerOperations>();
    }

    protected DigitalScanningTunerOperations narrow(org.omg.CORBA.Object connection) {
        DigitalScanningTunerOperations ops = DigitalScanningTunerHelper.narrow(connection);
        return ops; 
    }
    ...
    public void connectPort(final org.omg.CORBA.Object connection, final String connectionId) throws CF.PortPackage.InvalidPort, CF.PortPackage.OccupiedPort {
        try {
            synchronized (this.updatingPortsLock) {
                ...
                final DigitalScanningTunerOperations port = DigitalScanningTunerHelper.narrow(connection);
    ...
    public void setScanStrategy(String id, FRONTEND.ScanningTunerPackage.ScanStrategy scan_strategy) throws PortCallError
    {
        this.setScanStrategy(id, scan_strategy, "");
    }
    public void setScanStrategy(String id, FRONTEND.ScanningTunerPackage.ScanStrategy scan_strategy, String __connection_id__) throws PortCallError
    {
            ...
            if (this.active) {
                try {
                    if (!__connection_id__.isEmpty()) {
                        this.outPorts.get(__connection_id__).setScanStrategy(id, scan_strategy);
                    } else {
                        for (DigitalScanningTunerOperations p : this.outConnections.values()) {
                            p.setScanStrategy(id, scan_strategy);
                        }
                    }
    ...
    public void setScanStartTime(String id, BULKIO.PrecisionUTCTime start_time) throws PortCallError
    {
        this.setScanStartTime(id, start_time, "");
    }
    public void setScanStartTime(String id, BULKIO.PrecisionUTCTime start_time, String __connection_id__) throws PortCallError
    {
        synchronized(updatingPortsLock){
            try {
            ...
            if (this.active) {
                try {
                    if (!__connection_id__.isEmpty()) {
                        this.outPorts.get(__connection_id__).setScanStartTime(id, start_time);
                    } else {
                        for (DigitalScanningTunerOperations p : this.outConnections.values()) {
                            p.setScanStartTime(id, start_time);
                        }
                    }
                } catch(org.omg.CORBA.SystemException e) {
                    throw e;
    ...
    public FRONTEND.ScanningTunerPackage.ScanStatus getScanStatus(String id) throws PortCallError
    {
        return this.getScanStatus(id, "");
    }
    public FRONTEND.ScanningTunerPackage.ScanStatus getScanStatus(String id, String __connection_id__) throws PortCallError
    {
        FRONTEND.ScanningTunerPackage.ScanStatus retval = null;
        ...
        synchronized(updatingPortsLock){
            ...
            if (this.active) {
                try {
                    if (!__connection_id__.isEmpty()) {
                        retval = this.outPorts.get(__connection_id__).getScanStatus(id);
                    } else {
                        for (DigitalScanningTunerOperations p : this.outConnections.values()) {
                            retval = p.getScanStatus(id);
                        }
                    }
                } catch(org.omg.CORBA.SystemException e) {
                    throw e;
