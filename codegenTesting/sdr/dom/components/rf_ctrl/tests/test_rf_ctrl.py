...
class ComponentTests(ossie.utils.testing.RHTestCase):
    ...
    def testBasicBehavior(self):
        ...
        self.assertEquals(self.comp.set_rfinfo, "No connections available.")
        self.assertEquals(self.comp.get_available_rf, "No connections available.")
        self.assertEquals(self.comp.set_available_rf, "No connections available.")
        self.assertEquals(self.comp.get_current_rf, "No connections available.")
        self.assertEquals(self.comp.set_current_rf, "No connections available.")
        ...
        self.assertEquals(self.comp.set_tunercenterfrequency, "No connections available.")
        self.assertEquals(self.comp.get_tunerbandwidth, "No connections available.")
        self.assertEquals(self.comp.set_tunerbandwidth, "No connections available.")
        self.assertEquals(self.comp.get_tuneragcenable, "No connections available.")
        self.assertEquals(self.comp.set_tuneragcenable, "No connections available.")
        self.assertEquals(self.comp.get_tunergain, "No connections available.")
        self.assertEquals(self.comp.set_tunergain, "No connections available.")
        self.assertEquals(self.comp.get_tunerreferencesource, "No connections available.")
        self.assertEquals(self.comp.set_tunerreferencesource, "No connections available.")
        self.assertEquals(self.comp.get_tunerenable, "No connections available.")
        self.assertEquals(self.comp.set_tunerenable, "No connections available.")
        self.assertEquals(self.comp.get_tuneroutputsamplerate, "No connections available.")
        self.assertEquals(self.comp.set_tuneroutputsamplerate, "No connections available.")

        self.assertEquals(self.comp.get_gpsinfo, "No connections available.")
        self.assertEquals(self.comp.set_gpsinfo, "No connections available.")
        self.assertEquals(self.comp.get_gps_timepos, "No connections available.")
        self.assertEquals(self.comp.set_gps_timepos, "No connections available.")
        self.assertEquals(self.comp.get_nav_packet, "No connections available.")
        self.assertEquals(self.comp.set_nav_packet, "No connections available.")
