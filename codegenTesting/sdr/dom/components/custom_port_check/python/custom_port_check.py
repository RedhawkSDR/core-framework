...
from custom_port_check_base import *

class custom_port_check_i(custom_port_check_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", custom_port_check_i.MyMsg, self.msg_callback)
            ...
            msg_out = custom_port_check_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(custom_port_check_i)
