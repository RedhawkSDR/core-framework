...
# AUTO-GENERATED
#
# Source: struct_override.spd.xml
from ossie.resource import start_component
import logging

from struct_override_base import *

class struct_override_i(struct_override_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", struct_override_i.MyMsg, self.msg_callback)
            ...
            msg_out = struct_override_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(struct_override_i)
