 ...
 */
public class eos_test extends eos_test_base {
    /**
    ...
    **************************************************************************/
    ...
    protected int serviceFunction() {
        ...
        if (this.frontend_tuner_status.getValue().get(0).enabled.getValue()) {
        	float [] data = new float[1000];
        	this.port_dataFloat_out.pushPacket(data, bulkio.time.utils.now(), false, "hello");
        }
