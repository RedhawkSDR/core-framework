#ifndef EOS_TEST_I_IMPL_H
#define EOS_TEST_I_IMPL_H

#include "eos_test_base.h"

class eos_test_i : public eos_test_base
{
    ENABLE_LOGGING
    public:
        eos_test_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl);
        eos_test_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev);
        eos_test_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities);
        eos_test_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev);
        ~eos_test_i();
