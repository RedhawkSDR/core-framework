...
class fei_dev_python_i(fei_dev_python_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", fei_dev_python_i.MyMsg, self.msg_callback)
