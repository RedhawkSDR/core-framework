...
# AUTO-GENERATED
#
# Source: busy_comp.spd.xml
from ossie.resource import start_component
import logging

from busy_comp_base import *

class busy_comp_i(busy_comp_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", busy_comp_i.MyMsg, self.msg_callback)
